...
``ucm_compat_common.py``. It does not load a checkpoint and it does not
...
Run after editing the "User configuration" and "UCM configuration" sections::
    ...
    python scripts/ucm_compat_ascend.py
...
from examples.ucm_compat_common import (
    CacheFixture,
    UnsupportedEnvironment,
    current_vllm_config_context,
    log,
)
from examples.ucm_compat_common import make_cache as make_common_cache
from examples.ucm_compat_common import make_config as make_common_config
from examples.ucm_compat_common import (
    make_worker,
